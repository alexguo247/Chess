...
class Screen {
 ...
 public:
  ...
  ~Screen();
  // Draw a colour1ed filled in rectangle.
  void draw_rect(int x, int y, int w, int h, colour1 c);
  ...
  // add_font function.
  void draw_string(std::string msg, int x, int y, colour1 c, std::string fontKey="FUTURAM28");
