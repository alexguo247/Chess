...
vector<vector<int>> Knight::getAttackMoves(Board &b, bool flag)
{
    ...
    for (auto &d : dirs)
    {
        ...
        if ((b.getPiece(newRow, newCol) == nullptr || b.getPiece(newRow, newCol)->getColour() != colour) && flag && !b.causesCheck(this, {newRow, newCol}))
        {
